...
app = Flask(__name__)
app.secret_key = os.environ.get("SESSION_SECRET", "csv1000_secret")

@app.route('/')
def csv1000_test():
    return render_template('csv1000.html')
...
def save_result():
    try:
        ...
        test_data = {
            ...
            'contrast_levels': data.get('contrast_levels', []),
            'letter_accuracy': data.get('letter_accuracy', 0),
